		...
		<div class="col-md-4 col-12">
			...
			<ul class="list-unstyled">
				<li class="clearfix">
					...
					<span style="color: black"> 402B Lê Văn Lương, Quận 7, TPHCM</span><br>
				</li>
				<li class="clearfix">
				...
				<li class="clearfix">
					...
					<span style="color: black"><a href="mailto:sale.24hstore@gmail.com">smartstore.sales.2022@gmail.com</a></span>
				</li>
			</ul>
		</div>
